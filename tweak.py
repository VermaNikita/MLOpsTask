final = open('/root/mdpr/final.txt','r')
initial = open('/root/mdpr/initial.txt','r')
accuracy = open('/root/mdpr/accuracy.txt','r')
...
final=open('/root/mdpr/final.txt','w')
initial=open('/root/mdpr/initial.txt','w')
